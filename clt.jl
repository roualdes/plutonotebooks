...
md"Since statistics are random variables, they often follow some distribution ([for further details see Appendix: Details, in English](#english_details)).  Most times, we don't know the distribution associated with a statistic.  When the statistic is the mean, then this Central Limit Theorem tells us that the distribution of the sample mean is approximately Normal."
...
# ╔═╡ 089d1b3e-930b-11eb-3ab1-5da75ca170ed
md"### Details, in English"

# ╔═╡ 7b0e370a-930a-11eb-2e33-0bed472a2026
html"<div id=\"english_details\"></div>"

# ╔═╡ 1f93e9d0-930b-11eb-2220-332796c4523e
md"Assume you and your $$R-1$$ friends are sampling from distribution $$F$$ with mean $$\mu$$ and variance $$\sigma^2$$."
